...
/// where possible.
class HasIsGettersAnalyzerPlugin extends ServerPlugin {
  final Checker checker = Checker();

  HasIsGettersAnalyzerPlugin(ResourceProvider provider) : super(provider);
  ...
  @override
  String get name => 'Has Is Getters';
  ...
  String get contactInfo =>
      'https://github.com/marcelgarus/has_is_getters/issues';
